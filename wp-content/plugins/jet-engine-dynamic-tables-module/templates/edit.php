		...
		<div class="cx-vui-panel">
			...
			>
				...
				>
					...
					<cx-vui-switcher
						label="<?php _e( 'Allow CSV Export', 'jet-engine' ); ?>"
						description="<?php _e( 'Allow exporting this table\'s content as CSV on the frontend', 'jet-engine' ); ?>"
						:wrapper-css="[ 'equalwidth' ]"
						v-model="generalSettings.allow_csv_export"
					></cx-vui-switcher>
					<cx-vui-input
						label="<?php _e( 'Custom CSV Separator', 'jet-engine' ); ?>"
						description="<?php _e( 'Comma by default. Must be a single character', 'jet-engine' ); ?>"
						:wrapper-css="[ 'equalwidth' ]"
						:size="'fullwidth'"
						v-model="generalSettings.csv_separator"
						v-if="!!generalSettings.allow_csv_export"
					></cx-vui-input>
