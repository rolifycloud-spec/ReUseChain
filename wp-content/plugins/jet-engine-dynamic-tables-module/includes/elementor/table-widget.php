	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'description' => __( 'Use different query. Allow to use different data for same layout and avoid tables duplicating', 'jet-engine' ),
				'type'        => \Elementor\Controls_Manager::SWITCHER,
				'default'     => '',
			)
		);
		...
		$this->add_control(
			'enable_csv_export',
			array(
				'label'       => __( 'Enable CSV Export', 'jet-engine' ),
				'description' => __( 'Export will be available only if it is enabled in Table settings.', 'jet-engine' ),
				'type'        => \Elementor\Controls_Manager::SWITCHER,
				'default'     => '',
			)
		);
