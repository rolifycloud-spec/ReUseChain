...
$this->pages['us']['cookie-statement']['document_elements'] = array(
	...
	array(
		'content'   => 'We apply a prior-consent (opt-in) model on this website: non-functional cookies and similar tracking technologies are blocked and are not placed until you actively give your consent. You can grant, withdraw, or change your consent at any time.',
		'condition' => array(
			'us_california_optin' => 'yes',
		),
	),
...
We respect and understand that you may want to be sure that your personal information is not being sold or shared. You may request that we exclude your personal information from such arrangements, or direct us to limit the use and disclosure of possible sensitive personal information, by entering your name and email address below. You may need to provide additional identifying information before we can process your request.',
	...
	array(
		...
		'condition' => array(
			'us_california_optin' => 'NOT yes',
		),
	),
	array(
		'title'     => 'Browser and Device based Consent',
		'content'   => cmplz_sprintf( 'When you visit our website for the first time, we will show you a pop-up with an explanation about cookies. Non-functional cookies and similar technologies are not placed until you actively provide consent. As soon as you click on "%s", you consent to us using the cookies and plug-ins as described in the pop-up and this Cookie Policy. You can withdraw or change your consent at any time.', '[cookie_accept_text]' ),
		'condition' => array(
			'us_california_optin' => 'yes',
		),
	),
