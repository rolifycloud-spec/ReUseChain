	...
	class CX_Control_Checkbox extends CX_Controls_Base {
		...
		public function render() {
			...
			if ( ! empty( $this->settings['options'] ) || $this->settings['allow_custom_value'] ) {
				...
				$html .= '<div class="cx-checkbox-actions">';
				$html .= '<button type="button" class="cx-checkbox-action components-button is-secondary is-small" data-action="select-all">' . esc_html__( 'Select all', 'jet-engine' ) . '</button>';
				$html .= '<button type="button" class="cx-checkbox-action components-button is-secondary is-small is-destructive" data-action="deselect-all">' . esc_html__( 'Deselect all', 'jet-engine' ) . '</button>';
				$html .= '</div>';
