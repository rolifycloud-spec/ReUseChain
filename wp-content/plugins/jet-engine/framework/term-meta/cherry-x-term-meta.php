...
if ( ! class_exists( 'Cherry_X_Term_Meta' ) ) {
	...
	class Cherry_X_Term_Meta {
		 ...
		 * @param $field
		 */
		public static function _delete_repeater_separate_fields( $term_id, $key, $field ) {
			...
			foreach ( $field['fields'] as $repeater_field_key => $repeater_field ) {
				delete_term_meta( $term_id, self::_get_repeater_separate_field_key( $key, $repeater_field_key ) );
			}
		}
		 ...
		 * @param $field
		 */
		public static function _save_repeater_separate_fields( $term_id, $key, $value, $field ) {

			self::_delete_repeater_separate_fields( $term_id, $key, $field );
		...
		public function save_repeater_separate_fields( $term_id, $key, $value, $field ) {
			self::_save_repeater_separate_fields( $term_id, $key, $value, $field );
		}
