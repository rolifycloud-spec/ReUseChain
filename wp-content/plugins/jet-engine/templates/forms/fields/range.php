...
<div class="jet-form__field-wrap range-wrap">
	...
	<div class="jet-form__field-value range-value">
		<?php if ( ! empty( $args['prefix'] ) ): ?>
			<span class="jet-form__field-value-prefix"><?php echo wp_kses_post( $args['prefix'] ); ?></span>
		<?php endif; ?>
		<span class="jet-form__field-value-number"></span>
		<?php if ( ! empty( $args['suffix'] ) ): ?>
			<span class="jet-form__field-value-suffix"><?php echo wp_kses_post( $args['suffix'] ); ?></span>
		<?php endif; ?>
	</div>
</div>
