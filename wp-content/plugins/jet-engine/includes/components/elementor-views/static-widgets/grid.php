			...
			if ( $this->should_remove_wrapper() ) {
				$this->add_responsive_control(
					...
					array(
						...
						'selectors' => array(
							...
							':is( {{WRAPPER}} > .jet-listing-grid, {{WRAPPER}} > .jet-listing-grid > .jet-listing-grid__slider.slick-lib, {{WRAPPER}} > .jet-listing-grid > .jet-listing-grid__scroll-slider ) > .jet-listing-grid__items' => 'margin-left: calc( {{SIZE}}{{UNIT}} / -2); margin-right: calc( {{SIZE}}{{UNIT}} / -2); width: calc(100% + {{SIZE}}{{UNIT}});',
							'{{WRAPPER}} > .jet-listing-grid:has( > .jet-listing-grid__slider.swiper-lib )' => 'margin-left: calc( {{SIZE}}{{UNIT}} / -2); margin-right: calc( {{SIZE}}{{UNIT}} / -2);',
						),
					)
				);
				...
				$this->add_responsive_control(
					...
					array(
						...
						'size_units' => array( 'px', 'em', 'rem', 'custom' ),
						'selectors' => array(
							':is( {{WRAPPER}} > .jet-listing-grid > .jet-listing-grid__slider.swiper-lib > .jet-listing-grid__items, {{WRAPPER}} > .jet-listing-grid > .jet-listing-grid__items, {{WRAPPER}} > .jet-listing-grid > .jet-listing-grid__slider > .jet-listing-grid__items > .slick-list > .slick-track, {{WRAPPER}} > .jet-listing-grid > .jet-listing-grid__scroll-slider > .jet-listing-grid__items ) > .jet-listing-grid__item' => 'padding-top: calc({{SIZE}}{{UNIT}} / 2); padding-bottom: calc({{SIZE}}{{UNIT}} / 2);',
				...
				$this->add_responsive_control(
					...
					array(
						...
						'selectors' => array(
							...
							':is( {{WRAPPER}} > .elementor-widget-container > .jet-listing-grid, {{WRAPPER}} > .elementor-widget-container > .jet-listing-grid > .jet-listing-grid__slider.slick-lib, {{WRAPPER}} > .elementor-widget-container > .jet-listing-grid > .jet-listing-grid__scroll-slider ) > .jet-listing-grid__items' => 'margin-left: calc( {{SIZE}}{{UNIT}} / -2); margin-right: calc( {{SIZE}}{{UNIT}} / -2); width: calc(100% + {{SIZE}}{{UNIT}});',
							'{{WRAPPER}} > .elementor-widget-container > .jet-listing-grid:has( > .jet-listing-grid__slider.swiper-lib )' => 'margin-left: calc( {{SIZE}}{{UNIT}} / -2); margin-right: calc( {{SIZE}}{{UNIT}} / -2);',
						),
					)
				);
