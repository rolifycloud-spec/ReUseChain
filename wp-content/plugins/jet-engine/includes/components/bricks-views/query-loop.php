...
class Query_Loop {
	...
	public function maybe_modify_is_main_query( $is_main_query ) {
		...
		$is_method_exists = class_exists( 'Bricks\\Woocommerce_Helpers' ) && method_exists( 'Bricks\\Woocommerce_Helpers', 'is_archive_product' );
		$is_wc_archive    = $is_method_exists && Woocommerce_Helpers::is_archive_product();

		if ( $is_main_query && ( 'archive' === $content_type || $is_wc_archive ) ) {
