	...
	<div class="jet-engine-edit-page__fields">
		...
		<div class="cx-vui-panel">
			...
			<cx-vui-select
				...
				description="<?php _e( 'Define who can access this endpoint. Public access should be used only when exposing the query output is intentional.', 'jet-engine' ); ?><br><a href='https://developer.wordpress.org/rest-api/using-the-rest-api/authentication/' target='_blank'><?php _e( 'Read more about WordPress Rest API authentication', 'jet-engine' ); ?></a>"
				:wrapper-css="[ 'equalwidth' ]"
				:options-list="[
					{
						value: 'cap',
