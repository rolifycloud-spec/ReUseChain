		...
		>
			...
			>
				...
				<cx-vui-select
					...
					description="<?php _e( 'Field to order users by', 'jet-engine' ); ?>"
					:wrapper-css="[ 'equalwidth' ]"
						...
						>
							...
							>
								...
								<cx-vui-input
									...
									description="<?php _e( 'Date to retrieve users after. Eg. January 1st 2020, Today, Tomorrow etc.', 'jet-engine' ); ?>"
									:wrapper-css="[ 'equalwidth', 'has-macros' ]"
									size="fullwidth"
								...
								<cx-vui-input
									...
									description="<?php _e( 'Date to retrieve users before. Eg. January 1st 2020, Today, Tomorrow etc.', 'jet-engine' ); ?>"
									:wrapper-css="[ 'equalwidth', 'has-macros' ]"
									size="fullwidth"
								...
								<cx-vui-select
									...
									description="<?php _e( 'Users column to query against', 'jet-engine' ); ?>"
									:wrapper-css="[ 'equalwidth' ]"
									:options-list="[
										{
