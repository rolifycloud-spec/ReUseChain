...
if ( ! class_exists( 'Jet_Engine_CPT_User_Meta' ) ) {
	...
	class Jet_Engine_CPT_User_Meta extends Jet_Engine_CPT_Meta {
		 ...
		 * @param $field
		 */
		public static function _delete_repeater_separate_fields( $user_id, $key, $field ) {
			...
			foreach ( $field['fields'] as $repeater_field_key => $repeater_field ) {
				delete_user_meta( $user_id, self::_get_repeater_separate_field_key( $key, $repeater_field_key ) );
			}
		}
		 ...
		 * @param $field
		 */
		public static function _save_repeater_separate_fields( $user_id, $key, $value, $field ) {

			self::_delete_repeater_separate_fields( $user_id, $key, $field );
		...
		public function save_repeater_separate_fields( $user_id, $key, $value, $field ) {
			self::_save_repeater_separate_fields( $user_id, $key, $value, $field );
		}
