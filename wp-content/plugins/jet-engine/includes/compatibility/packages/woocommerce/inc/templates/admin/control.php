...
?>
<div class="cx-ui-kit cx-control cx-control-<?php echo esc_attr( $args['type'] ); ?> cx-control-inline<?php echo esc_attr( $required_class ); ?>" data-control-name="<?php echo esc_attr( $args['id'] ); ?>">
