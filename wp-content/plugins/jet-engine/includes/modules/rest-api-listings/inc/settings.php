...
class Settings {
	...
	public function save_endpoint() {
		...
		if ( $with_sample_request ) {
			...
			$args      = isset( $prev_item['args'] ) ? jet_engine_safe_unserialize_array( $prev_item['args'], 'rest_api_listings_settings_args' ) : array();
				...
				<div class="cx-vui-inner-panel">
					<div tabindex="0" class="cx-vui-repeater">
						...
						<div class="cx-vui-repeater__actions">
							...
							>
								<span slot="label">
									<?php esc_html_e( '+ New Endpoint', 'jet-engine' ); ?>
								</span>
							</cx-vui-button>
							<cx-vui-button
							...
							>
								<span slot="label">
									<?php esc_html_e( 'Add Sample Endpoint', 'jet-engine' ); ?>
								</span>
							</cx-vui-button>
						</div>
					</div>
