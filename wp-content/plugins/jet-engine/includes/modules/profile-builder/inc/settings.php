...
class Settings {
	...
	public function menu_page_assets() {
		...
		$user_page_default_option = array(
			array(
				'value' => 'default',
				'label' => __( 'Default behavior (show page as is)', 'jet-engine' ),
			),
		);

		$not_accessible_actions = array(
			array(
				'value' => 'page_redirect',
		...
		$not_logged_in_actions = array_merge(
			array(
				array(
		...
		$user_page_not_logged_in_actions = array_merge(
			$user_page_default_option,
			$not_logged_in_actions
		);

		$user_page_not_accessible_actions = array_merge(
			$user_page_default_option,
			$not_accessible_actions
		);
		...
		wp_localize_script(
			...
			array(
				...
				'not_logged_in_actions' => $not_logged_in_actions,
				'user_page_not_logged_in_actions' => $user_page_not_logged_in_actions,
				'not_accessible_actions' => $not_accessible_actions,
				'user_page_not_accessible_actions' => $user_page_not_accessible_actions,
