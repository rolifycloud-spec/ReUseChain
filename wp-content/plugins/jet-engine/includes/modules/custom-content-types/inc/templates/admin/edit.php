	...
	<div class="jet-engine-edit-page__fields">
		...
		>
			...
			<div class="cx-vui-panel" slot="content">
				...
				></cx-vui-switcher>
				<cx-vui-switcher
					label="<?php _e( 'Delete CCT item on Single Post deletion', 'jet-engine' ); ?>"
					description="<?php _e( 'Check this if you need the CCT item to be deleted when its Single Post was deleted permanently (not trashed).', 'jet-engine' ); ?>"
					:wrapper-css="[ 'equalwidth' ]"
					v-model="generalSettings.delete_item_on_single_delete"
					:conditions="[
						{
