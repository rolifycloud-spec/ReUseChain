...
import DeleteCustomContentType from './Edit';

export default {
	type: 'delete_custom_content_type',
	label: __( 'Delete Custom Content Type Item', 'jet-engine' ),
	edit: DeleteCustomContentType,
