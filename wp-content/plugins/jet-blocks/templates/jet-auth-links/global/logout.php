...
<div class="jet-auth-links__section jet-auth-links__logout">
    ...
    ?>
	<a class="jet-auth-links__item" href="<?php echo esc_url( $this->__logout_url() ); ?>" aria-label="<?php echo esc_attr( ! empty( $settings['logout_link_text'] ) ? wp_strip_all_tags( $settings['logout_link_text'] ) : esc_html__( 'Logout', 'jet-blocks' ) ); ?>"><?php
