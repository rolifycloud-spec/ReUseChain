...
<div class="jet-auth-links__section jet-auth-links__registered">
	...
	<a class="jet-auth-links__item" href="<?php echo esc_url( $url ); ?>" aria-label="<?php echo esc_attr( ! empty( $settings['registered_link_text'] ) ? wp_strip_all_tags( $settings['registered_link_text'] ) : esc_html__( 'My Account', 'jet-blocks' ) ); ?>"><?php
