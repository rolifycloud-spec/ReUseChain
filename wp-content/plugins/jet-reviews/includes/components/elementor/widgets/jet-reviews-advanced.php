...
class Jet_Reviews_Advanced extends Jet_Reviews_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'captcha_validation_failed_message',
			array(
				'label'       => esc_html__( 'Captcha Validation Failed Message', 'jet-reviews' ),
				'label_block' => true,
				'type'        => Controls_Manager::TEXT,
				'default'     => '',
				'placeholder' => esc_html__( '*Captcha validation failed', 'jet-reviews' ),
			)
		);
		...
		$this->add_control(
			'rating_label',
			array(
				'label'       => esc_html__( 'Rating Label', 'jet-reviews' ),
				'label_block' => true,
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Rating', 'jet-reviews' ),
			)
		);
		...
		$this->add_control(
			'upload_control_label',
			array(
				'label'       => esc_html__( 'Upload Control Label', 'jet-reviews' ),
				'label_block' => true,
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Upload your file here, or', 'jet-reviews' ),
			)
		);
		...
		$this->add_control(
			'upload_button_label',
			array(
				'label'       => esc_html__( 'Upload Button Label', 'jet-reviews' ),
				'label_block' => true,
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Choose File', 'jet-reviews' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'       => esc_html__( 'Max File Size Label', 'jet-reviews' ),
				'label_block' => true,
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Maximum size', 'jet-reviews' ),
			)
		);
		...
		$this->add_control(
			'header_review_message_heading',
			array(
				'label'     => esc_html__( 'Review Message', 'jet-reviews' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_responsive_control(
			'header_review_message_space',
			array(
				'label' => esc_html__( 'Message Spacing', 'jet-reviews' ),
				'type'  => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => 0,
				...
				'selectors' => array(
					'{{WRAPPER}} ' . $css_scheme['header'] . ' .jet-reviews-message' => ! is_rtl() ? 'margin-left: {{SIZE}}{{UNIT}}; margin-right: 0;' : 'margin-left: 0; margin-right: {{SIZE}}{{UNIT}};',
				),
			)
		);

		$this->add_control(
			'header_review_message_color',
			array(
				'label'  => esc_html__( 'Message Color', 'jet-reviews' ),
				'type'   => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} ' . $css_scheme['header'] . ' .jet-reviews-message' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			array(
				'label'    => esc_html__( 'Message Typography', 'jet-reviews' ),
				'name'     => 'header_review_message_typography',
				'selector' => '{{WRAPPER}} ' . $css_scheme['header'] . ' .jet-reviews-message',
			)
		);
	...
	protected function render() {
		...
		$instance_settings = array(
			...
			'labels' => array(
				...
				'ratingLabel'              => esc_attr( $settings[ 'rating_label' ] ),
				...
				'captchaValidationFailed'  => esc_attr( $settings[ 'captcha_validation_failed_message' ] ),
				'uploadControlLabel'       => esc_attr( $settings[ 'upload_control_label' ] ),
				'buttonLabel'              => esc_attr( $settings[ 'upload_button_label' ] ),
				'maxFileSizeLabel'         => esc_attr( $settings[ 'upload_max_size_label' ] ),
			),
		);
