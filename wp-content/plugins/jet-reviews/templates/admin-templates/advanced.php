...
<!-- Existing translated Vue control labels use _e(). -->
<div
	class="jet-reviews-settings-page jet-reviews-settings-page__advanced"
>
    <cx-vui-switcher
        name="hide-post-author-review-control"
        label="<?php _e( 'Hide review form for post author', 'jet-reviews' ); ?>"
        description="<?php _e( 'Hide the review form when the current user is the post author.', 'jet-reviews' ); ?>"
        :wrapper-css="[ 'equalwidth' ]"
        :return-true="true"
        :return-false="false"
        v-model="pageOptions['hide-post-author-review-control']['enable']"
    >
    </cx-vui-switcher>
