...
>
	<cx-vui-switcher
		...
		label="<?php esc_html_e( 'Use SEO & Sitemap Rules', 'jet-smart-filters' ); ?>"
		description="<?php esc_html_e( 'Configure rules to generate filters specific sitemaps', 'jet-smart-filters' ); ?>"
	...
	>
		<cx-vui-repeater
			...
			buttonLabel="<?php esc_html_e( 'Add Rule', 'jet-smart-filters' ); ?>"
			buttonSize="mini"
		...
		<div class="seo-sitemap-rules-actions">
			...
			>
				<template v-slot:label>
					...
					<span><?php esc_html_e( 'Save Rules', 'jet-smart-filters' ); ?></span>
				</template>
			</cx-vui-button>
			<div
