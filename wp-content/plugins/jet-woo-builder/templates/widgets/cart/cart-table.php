...
<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
		...
		<tr <?php echo $row_styles; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?> > 
...
$collaterals = trim( ob_get_clean() );

if ( '' !== $collaterals ) :
?>
<div class="cart-collaterals">
	<?php echo $collaterals; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
</div>
<?php endif; ?>
