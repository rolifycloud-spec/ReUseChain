...
<li <?php wc_product_class( ' jet-woo-builder-product jet-woo-builder-archive-item-' . $product->get_id(), $product ); ?> data-product-id="<?php echo esc_attr( $product->get_id() ); ?>">
	<?php echo apply_filters( 'jet-woo-builder/elementor-views/frontend/archive-item-content', $content, $template, $product ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
</li>
