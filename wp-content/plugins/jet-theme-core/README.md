...
## 2.3.2 - 12.08.2026
- Added: All is selected by default for applicable Theme Builder conditions, with a description explaining its behavior
- Updated: Site Conditions synchronization action renamed to Rebuild Site Conditions and its description clarified
- Updated: Theme Builder plugin link now opens the current Theme Builder page
- Fixed: Shortcodes are processed in Theme Builder location templates
- Fixed: WordPress admin bar visibility when Theme Builder overrides the page header
- Fixed: Jet Dashboard data handling and output sanitization

## 2.3.1.2 - 07.04.2026
- Fixed: CX framework loader
