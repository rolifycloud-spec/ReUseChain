		...
		initVueComponents: function() {
			...
			Vue.component( 'jet-theme-core-template-conditions-item', {
				...
				watch: {
					...
					subGroupValueControl: function( curr ) {
						this.setDefaultSubGroupValue();
					}
				},
				...
				computed: {
					...
					subGroupValueDescription: function() {
						return this.subGroupValueControl && this.subGroupValueControl.description ? this.subGroupValueControl.description : '';
					},
					...
					subGroupArgControl: function() {
						...
						return subGroupData.argControl;
					},

					subGroupArgVisible: function() {
						return this.subGroupArgControl ? true : false;
					},

					subGroupArgAction: function() {

						if ( ! this.subGroupArgControl ) {
							return false;
						}

						return this.subGroupArgControl.action;
					},

					subGroupArgOptions: function() {

						if ( ! this.subGroupArgControl ) {
							return false;
						}

						return this.subGroupArgControl.options;
					},
				},
				...
				methods: {
					...
					getDefaultSubGroupValue: function() {

						if ( ! this.subGroupValueControl ) {
							return '';
						}

						if ( this.subGroupValueControl.hasOwnProperty( 'default' ) ) {
							return Array.isArray( this.subGroupValueControl.default )
								? [ ...this.subGroupValueControl.default ]
								: this.subGroupValueControl.default;
						}
					...
					isDefaultSubGroupValueState: function() {

						if ( Array.isArray( this.сondition.subGroupValue ) ) {
							return 0 === this.сondition.subGroupValue.length;
						}

						return '' === this.сondition.subGroupValue || false === this.сondition.subGroupValue || null === this.сondition.subGroupValue;
					},

					setDefaultSubGroupValue: function() {

						if ( ! this.subGroupValueControl || ! this.isDefaultSubGroupValueState() ) {
							return;
						}

						this.сondition.subGroupValue = this.getDefaultSubGroupValue();
					},
					...
					subGroupArgInputHandler: function ( value ) {
						this.сondition.subGroupArg = value;
					},
				},
