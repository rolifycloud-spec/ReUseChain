        ...
        >
            ...
            >
                ...
                <div class="jet-template-library-form__body">
                    <cx-vui-select
                            name="templateType"
                            label="<?php esc_attr_e( 'Template Type', 'jet-theme-core' ); ?>"
                            placeholder="<?php esc_attr_e( 'Select template type', 'jet-menu' ); ?>"
                    ...
                    <cx-vui-select
                            ...
                            label="<?php esc_attr_e( 'Template Content Type', 'jet-theme-core' ); ?>"
                            placeholder="<?php esc_attr_e( 'Select template content type', 'jet-menu' ); ?>"
                            :wrapper-css="[ 'vertical-fullwidth' ]"
                            size="fullwidth"
                    ...
                    <cx-vui-input
                            name="templateName"
                            label="<?php esc_attr_e( 'Template Name', 'jet-theme-core' ); ?>"
                            placeholder="<?php esc_attr_e( 'Enter template name(optional)', 'jet-menu' ); ?>"
                            :wrapper-css="[ 'vertical-fullwidth' ]"
                            size="fullwidth"
                            type="text"
                ...
                <div class="jet-template-library-form__footer">
                    ...
                    >
                        <span slot="label"><?php esc_html_e( 'Create Template', 'jet-theme-core' ); ?></span>
                    </cx-vui-button>
                </div>
            </div>
        </cx-vui-popup>
    ...
    <transition name="cx-popup">
        ...
        >
            <div class="cx-vui-popup__content-inner" slot="content">
                ...
                >
                    <div class="jet-template-library-form__header">
	                    <div class="jet-template-library-form__header-icon"><?php
							// The icon is selected from the plugin's static SVG map.
							// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
							echo \Jet_Theme_Core\Utils::get_admin_ui_icon( 'info' );
						?></div>
                        <div class="jet-template-library-form__header-title"><?php esc_html_e( 'Theme Template Conditions', 'jet-theme-core' ); ?></div>
                    </div>
                    <div class="jet-template-library-form__body">
                        <p><?php esc_html_e( 'Use the template conditions for theme locations for topics that support them. We recommended you use the JetThemeBuilder to create new pages for your site.', 'jet-theme-core' ); ?></p>
                        <p><?php esc_html_e( 'Conditions in Theme Templates and the ones you set while creating the template in Theme Builder are different. Conditions from Theme Builder work with any theme from Crocoblock Installation Wizard and rerender the page structure completely or partially.', 'jet-theme-core' ); ?></p>
                    </div>
                    <div class="jet-template-library-form__footer">
                        <cx-vui-button
                                button-style="default"
                        ...
                        >
                            <template v-slot:label>
                                <span><?php esc_html_e( 'Cancel', 'jet-theme-core' ); ?></span>
                            </template>
                        </cx-vui-button>
                        <cx-vui-button
                            button-style="default"
                            ...
                            size="mini"
                            tag-name="a"
	                            url="<?php echo esc_url( \Jet_Theme_Core\Utils::get_theme_bilder_link() ); ?>"
                            target="_blank"
                        >
                            <span slot="label"><?php esc_html_e( 'Go to JetThemeBuilder', 'jet-theme-core' ); ?></span>
                        </cx-vui-button>
                    </div>
                </div>
            </div>
