...
>
	<div class="jet-theme-core-conditions-manager__container">
		<div class="jet-theme-core-conditions-manager__blank">
			<div class="jet-theme-core-conditions-manager__blank-title"><?php echo esc_html__( 'Set the page template visibility conditions', 'jet-theme-core' ); ?></div>
			<div class="jet-theme-core-conditions-manager__blank-message">
				<span><?php echo esc_html__( 'Here you can set one or multiple conditions, according to which the given template will be either shown or hidden on specific pages.', 'jet-theme-core' ); ?></span>
			</div>
		</div>
                ...
                >
                    <template v-slot:label>
                        <span class="svg-icon">
	                        ...
	                        <span><?php echo esc_html__( 'Add condition', 'jet-theme-core' ); ?></span>
                    </template>
                </cx-vui-button>
            </div>
		</div>
	...
	<div class="jet-theme-core-conditions-manager__controls">
		...
		>
            <template v-slot:label>
	                <span><?php echo esc_html__( 'Save Conditions', 'jet-theme-core' ); ?></span>
            </template>
		</cx-vui-button>
	</div>
</div>
